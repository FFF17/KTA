    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" autocomplete="off" action="{{ route('post-register') }}" enctype="multipart/form-data" aria-label="{{ __('Register') }}">
...
@endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nik" type="number" class="form-control{{ $errors->has('nik') ? ' is-invalid' : '' }}" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==16) return false;" name="nik" value="{{ old('nik') }}" maxlength="16" required autofocus>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_lahir" type="date"  min="1960-01-01" max="2001-12-31"class="form-control{{ $errors->has('tanggal_lahir') ? ' is-invalid' : '' }}" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required autofocus>
        ...
        <div class="input-group-prepend">
          <span class="input-group-text" value="+62"  name="telepon">+62</span>
                                ...
                                <input id="telepon" type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;"  class="form-control{{ $errors->has('telepon') ? ' is-invalid' : '' }}" name="telepon" value="{{ old('telepon') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="foto" type="file" class="form-control{{ $errors->has('foto') ? ' is-invalid' : '' }}" name="foto" value="{{ old('foto') }}" required><p style="color: red;">*Max 2048KB|jpeg,png,jpg</p>
 ...
 <script type="text/javascript">
    jQuery(document).ready(function ()
    {
            jQuery('select[name="provinsi"]').on('change',function(){
               ...
               {
                  jQuery.ajax({
                     url : 'register/getkabupaten/' +provinsiID,
                     type : "GET",
                     dataType : "json",
            ...
            jQuery('select[name="kabupaten"]').on('change',function(){
               ...
               {
                  jQuery.ajax({
                     url : 'register/getkecamatan/' +kabupatenID,
                     type : "GET",
                     dataType : "json",
                     success:function(data)
                     {
               ...
               {
                  jQuery.ajax({
                     url : 'register/getkelurahan/' +kecamatanID,
                     type : "GET",
                     dataType : "json",
                     success:function(data)
                     {
